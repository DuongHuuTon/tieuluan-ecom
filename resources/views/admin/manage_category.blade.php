...
@section('container')
    ...
    <h1 class="mb10 fs-3">Quản lý danh mục</h1>
                        ...
                        <div class="card-body">
                            <form action="{{route('category.manage_category_process')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label for="category_name" class="control-label mb-1">Tên danh mục</label>
                                        ...
                                        <div class="col-md-4">
                                            <label for="category_name" class="control-label mb-1">Danh mục cha</label>
                                        ...
                                        <div class="col-md-4">
                                            <label for="category_slug" class="control-label mb-1">Đường dẫn tĩnh</label>
                                ...
                                <div class="form-group">
                                    <label for="image" class="control-label mb-1">Ảnh danh mục</label>
                                    ...
                                    @if($category_image != '')
                                        <a href="{{asset('storage/media/category/'.$category_image)}}" target="_blank">
                                            <img width="250px" class="mt-3" src="{{asset('storage/media/category/'.$category_image)}}"/>
                                        </a>
                                    @endif
                                </div>
                                <div class="form-group">
